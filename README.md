...
[![Build Status](https://circleci.com/gh/prestonbernstein/react-redux-synthesizer/tree/master.svg?style=shileld&circle-token=:circle-token)](https://circleci.com/gh/prestonbernstein/react-redux-synthesizer/tree/master.svg?circle-token=:circle-token)
